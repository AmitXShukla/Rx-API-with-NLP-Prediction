...
Loop features an active NLP AI which further classify studies based using on-premise pre-trained NLP Predictive Analytics and find similar matching project studies in local databases.
